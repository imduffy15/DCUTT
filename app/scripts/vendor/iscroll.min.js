...
{enabled:!0,x:0,y:0,steps:[],scale:1,handleEvent:function(a){switch(a.type){case o:if(!h&&a.button!==0)break;this._start(a);break;case k:this._move(a);break;case l:case m:this._end(a);break;case n:this._resize();break;case "mouseout":this._mouseout(a);break;case "webkitTransitionEnd":this._transitionEnd(a)}},_resize:function(){this.refresh()},_pos:function(a,c){a=this.hScroll?a:0;c=this.vScroll?c:0;this.options.useTransform?this.scroller.style[g+"Transform"]=r+a+"px,"+c+"px"+s+" scale("+this.scale+
...
"Transform"].replace(/[^0-9-.,]/g,"").split(","),e=b[4]*1,b=b[5]*1):(e=getComputedStyle(this.scroller,null).left.replace(/[^0-9-]/g,"")*1,b=getComputedStyle(this.scroller,null).top.replace(/[^0-9-]/g,"")*1),e!=this.x||b!=this.y))this.options.useTransition?this._unbind("webkitTransitionEnd"):q(this.aniTime),this.steps=[],this._pos(e,b);this.startX=this.x;this.startY=this.y;this.pointX=c.pageX;this.pointY=c.pageY;this.startTime=a.timeStamp||Date.now();this.options.onScrollStart&&this.options.onScrollStart.call(this,
a);this._bind(k);this._bind(l);this._bind(m)}},_move:function(a){var c=h?a.touches[0]:a,b=c.pageX-this.pointX,e=c.pageY-this.pointY,d=this.x+b,f=this.y+e,g=a.timeStamp||Date.now();this.options.onBeforeScrollMove&&this.options.onBeforeScrollMove.call(this,a);this.pointX=c.pageX;this.pointY=c.pageY;if(d>0||d<this.maxScrollX)d=this.options.bounce?this.x+b/2:d>=0||this.maxScrollX>=0?0:this.maxScrollX;if(f>0||f<this.maxScrollY)f=this.options.bounce?this.y+e/2:f>=0||this.maxScrollY>=0?0:this.maxScrollY;
this.distX+=b;this.distY+=e;this.absDistX=i.abs(this.distX);this.absDistY=i.abs(this.distY);if(!(this.absDistX<6&&this.absDistY<6)){if(this.options.lockDirection)if(this.absDistX>this.absDistY+5)f=this.y,e=0;else if(this.absDistY>this.absDistX+5)d=this.x,b=0;this.moved=!0;this._pos(d,f);this.dirX=b>0?-1:b<0?1:0;this.dirY=e>0?-1:e<0?1:0;if(g-this.startTime>300)this.startTime=g,this.startX=this.x,this.startY=this.y;this.options.onScrollMove&&this.options.onScrollMove.call(this,a)}},_end:function(a){if(!(h&&
a.touches.length!=0)){var c=h?a.changedTouches[0]:a,b,e,d={dist:0,time:0},f={dist:0,time:0},g=(a.timeStamp||Date.now())-this.startTime;b=this.x;e=this.y;this._unbind(k);this._unbind(l);this._unbind(m);this.options.onBeforeScrollEnd&&this.options.onBeforeScrollEnd.call(this,a);if(this.moved){if(g<300&&this.options.momentum){d=b?this._momentum(b-this.startX,g,-this.x,this.scrollerW-this.wrapperW+this.x,this.options.bounce?this.wrapperW:0):d;f=e?this._momentum(e-this.startY,g,-this.y,this.maxScrollY<
0?this.scrollerH-this.wrapperH+this.y:0,this.options.bounce?this.wrapperH:0):f;b=this.x+d.dist;e=this.y+f.dist;if(this.x>0&&b>0||this.x<this.maxScrollX&&b<this.maxScrollX)d={dist:0,time:0};if(this.y>0&&e>0||this.y<this.maxScrollY&&e<this.maxScrollY)f={dist:0,time:0}}d.dist||f.dist?(c=i.max(i.max(d.time,f.time),10),this.scrollTo(b>>0,e>>0,c)):this._resetPos(200)}else{if(h){for(b=c.target;b.nodeType!=1;)b=b.parentNode;if(b.tagName!="SELECT"&&b.tagName!="INPUT"&&b.tagName!="TEXTAREA")e=document.createEvent("MouseEvents"),
e.initMouseEvent("click",!0,!0,a.view,1,c.screenX,c.screenY,c.clientX,c.clientY,a.ctrlKey,a.altKey,a.shiftKey,a.metaKey,0,null),e._fake=!0,b.dispatchEvent(e)}this._resetPos(200)}this.options.onTouchEnd&&this.options.onTouchEnd.call(this,a)}},_resetPos:function(a){var c=this.x>=0?0:this.x<this.maxScrollX?this.maxScrollX:this.x,b=this.y>=0||this.maxScrollY>0?0:this.y<this.maxScrollY?this.maxScrollY:this.y;if(c==this.x&&b==this.y){if(this.moved)this.options.onScrollEnd&&this.options.onScrollEnd.call(this),
this.moved=!1}else this.scrollTo(c,b,a||0)},_mouseout:function(a){var c=a.relatedTarget;if(c)for(;c=c.parentNode;)if(c==this.wrapper)return;this._end(a)},_transitionEnd:function(a){a.target==this.scroller&&(this._unbind("webkitTransitionEnd"),this._startAni())},_startAni:function(){var a=this,c=a.x,b=a.y,e=Date.now(),d,f,g;if(!a.animating)if(a.steps.length){d=a.steps.shift();if(d.x==c&&d.y==b)d.time=0;a.animating=!0;a.moved=!0;a.options.useTransition?(a._transitionTime(d.time),a._pos(d.x,d.y),a.animating=
!1,d.time?a._bind("webkitTransitionEnd"):a._resetPos(0)):(g=function(){var h=Date.now();if(h>=e+d.time)a._pos(d.x,d.y),a.animating=!1,a.options.onAnimationEnd&&a.options.onAnimationEnd.call(a),a._startAni();else if(h=(h-e)/d.time-1,f=i.sqrt(1-h*h),h=(d.x-c)*f+c,a._pos(h,(d.y-b)*f+b),a.animating)a.aniTime=x(g)},g())}else a._resetPos(400)},_transitionTime:function(a){this.scroller.style[g+"TransitionDuration"]=a+"ms"},_momentum:function(a,c,b,e,d){var c=i.abs(a)/c,f=c*c/0.0012,g=0,g=0;a>0&&f>b?(b+=
d/(6/(f/c*6.0E-4)),c=c*b/f,f=b):a<0&&f>e&&(e+=d/(6/(f/c*6.0E-4)),c=c*e/f,f=e);f*=a<0?-1:1;return{dist:f,time:c/6.0E-4>>0}},_offset:function(a){for(var c=-a.offsetLeft,b=-a.offsetTop;a=a.offsetParent;)c-=a.offsetLeft,b-=a.offsetTop;return{left:c,top:b}},_bind:function(a,c,b){(c||this.scroller).addEventListener(a,this,!!b)},_unbind:function(a,c,b){(c||this.scroller).removeEventListener(a,this,!!b)},destroy:function(){this.scroller.style[g+"Transform"]="";this._unbind(n,window);this._unbind(o);this._unbind(k);
...
this.options.hScroll&&this.maxScrollX<0;this.vScroll=this.options.vScroll&&(!this.options.bounceLock&&!this.hScroll||this.scrollerH>this.wrapperH);a=this._offset(this.wrapper);this.wrapperOffsetLeft=-a.left;this.wrapperOffsetTop=-a.top;this.scroller.style[g+"TransitionDuration"]="0";this._resetPos(200)},scrollTo:function(a,c,b,e){var d=a;this.stop();d.length||(d=[{x:a,y:c,time:b,relative:e}]);for(a=0,c=d.length;a<c;a++){if(d[a].relative)d[a].x=this.x-d[a].x,d[a].y=this.y-d[a].y;this.steps.push({x:d[a].x,
y:d[a].y,time:d[a].time||0})}this._startAni()},scrollToElement:function(a,c){var b;if(a=a.nodeType?a:this.scroller.querySelector(a))b=this._offset(a),b.left+=this.wrapperOffsetLeft,b.top+=this.wrapperOffsetTop,b.left=b.left>0?0:b.left<this.maxScrollX?this.maxScrollX:b.left,b.top=b.top>0?0:b.top<this.maxScrollY?this.maxScrollY:b.top,c=c===void 0?i.max(i.abs(b.left)*2,i.abs(b.top)*2):c,this.scrollTo(b.left,b.top,c)},disable:function(){this.stop();this._resetPos(0);this.enabled=!1;this._unbind(k);this._unbind(l);
this._unbind(m)},enable:function(){this.enabled=!0},stop:function(){q(this.aniTime);this.steps=[];this.animating=this.moved=!1}};typeof exports!=="undefined"?exports.iScroll=j:window.iScroll=j})();
